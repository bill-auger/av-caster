...
/* PresetSeed public class methods */

ValueTree PresetSeed::DefaultStore()
{
...
ValueTree PresetSeed::PresetSeeds()
{
  FilePresetSeed file_preset_seed ;
  RtmpPresetSeed rtmp_preset_seed ;
  LctvPresetSeed lctv_preset_seed ;
...
/* PresetSeed protected constructor */
...
void PresetSeed::createPreset()
{
  ...
  setValue(this->presetStore , CONFIG::OUTPUT_SINK_ID   , var(this->sinkIdx            )) ;
...
/* PresetSeed private methods */

void PresetSeed::setValue(ValueTree a_node , Identifier a_key , var a_value)
{
  a_node.setProperty(a_key , a_value , nullptr) ;
}


/* PresetSeed subclass public constructors */
