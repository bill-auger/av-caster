...
const Identifier CONFIG::CONFIG_PANE_ID        = "visible-config-pane" ;
// ConfigScreen IDs
...
const bool       CONFIG::DEFAULT_IS_IMAGE_ACTIVE   = false ;
...
const String     CONFIG::DEFAULT_CONFIG_PANE       = "Screen" ; // ASSERT: one of GUI::*_GROUP_TEXT
...
#define MEDIA_TOGGLE_IDS            STRING(SCREEN_ID        ) + newLine + STRING(CAMERA_ID       ) + newLine + \
                                    ...
                                    STRING(PREVIEW_ID       ) + newLine + STRING(AUDIO_ID        ) + newLine + \
                                    STRING(OUTPUT_ID        )
#define PRESET_CONFIG_IDS           STRING(IS_PENDING_ID    ) + newLine + STRING(PRESET_ID)
...
StringArray CONFIG::MediaToggleKeys()        { return StringArray::fromLines(MEDIA_TOGGLE_IDS                      ) ; }
StringArray CONFIG::PresetConfigKeys()       { return StringArray::fromLines(PRESET_CONFIG_IDS                     ) ; }
