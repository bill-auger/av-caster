...
Version:       0.16.004
Release:       1%{?dist}
Summary:       A light-weight native gStreamer GUI for screencast, webcam, and audio recording and streaming
License:       GPL-3.0
...
Requires:      gstreamer-plugins-bad gstreamer-plugins-good gstreamer-plugins-ugly libircclient1
%endif
%if 0%{?centos_version} || 0%{?fedora_version} || 0%{?rhel_version}
BuildRequires: freetype-devel gstreamer1-plugins-base-devel
Requires:      gstreamer1-plugins-bad-free gstreamer1-plugins-good gstreamer1-plugins-ugly libircclient
%endif
